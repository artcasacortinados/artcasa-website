...
const PapelParedePage = () => {
  ...
  const nextImage = () => {
    setCurrentImageIndex((prev) => (prev + 1) % papelItems.length)
  }
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <section className="relative py-24 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h1 className="text-4xl md:text-6xl lg:text-7xl font-black text-black leading-none mb-6">
            PAPEL DE
            <span className="block text-[#B5720A]">PAREDE</span>
          </h1>
          ...
          <p className="text-xl text-gray-700 leading-relaxed font-medium max-w-3xl mx-auto">
            Papéis de parede modernos e clássicos para transformar qualquer espaço. Desde padrões elegantes a texturas sofisticadas, temos a solução perfeita para o seu projeto.
          </p>
        </div>
      </section>
          ...
          <div className="max-w-4xl w-full relative">
            ...
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-2xl font-black text-white uppercase tracking-wide">
                Papel de Parede - {currentImageIndex + 1} de {papelItems.length}
              </h3>
              <button 
            ...
            <div className="relative">
              <img 
                src={papelItems[currentImageIndex]} 
                alt={`Papel de Parede ${currentImageIndex + 1}`}
      ...
      <CallToAction productName="nos nossos papéis de parede" />
